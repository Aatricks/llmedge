...
if (${ANDROID_ABI} STREQUAL "arm64-v8a")
    ...
    if (LLMEDGE_OPENCL_ENABLED)
        llmedge_enable_android_opencl("smollm_v8_4_fp16_dotprod_sve" "${GGML_DIR}")
    endif()
    build_library_arm64("smollm_v8_4_fp16_dotprod_i8mm" "-march=armv8.4-a+fp16+dotprod+i8mm")
    if (LLMEDGE_OPENCL_ENABLED)
        llmedge_enable_android_opencl("smollm_v8_4_fp16_dotprod_i8mm" "${GGML_DIR}")
    endif()
    ...
    if (LLMEDGE_OPENCL_ENABLED)
        llmedge_enable_android_opencl("smollm_v8_4_fp16_dotprod_i8mm_sve" "${GGML_DIR}")
    endif()
endif()
